 ...
 if (isset($_GET['edit'])) {
     ...
     if (isset($_POST['save'])) {
       ...
       $f_name=$_POST['f_name'];
        ...
        mysqli_query($db, "UPDATE stud_tbl SET f_name='$f_name', l_name='$l_name', gender='$gender', dob='$dob', address='$address', phone='$phone', email='$emaill'  WHERE id=$id");
 ...
 <?php while ($row = mysqli_fetch_array($results)) { ?>
        <tr>
            ...
            <td><?php echo $row['email']; ?></td> 
             ...
             <td>
                <a href="newstu.php?edit=<?php echo $row['id']; ?>" class="edit_btn" >Edit</a>
            </td>
