 ...
 if (isset($_GET['edit'])) {
     ...
     if (isset($_POST['save'])) {
       ...
       $f_name=$_POST['f_name'];
        ...
        mysqli_query($db, "UPDATE faculty_tbl SET f_name='$f_name', l_name='$l_name', gender='$gender', department='$department', salary='$salary', phone='$phone', email='$emaill'  WHERE id=$id");
 ...
 <?php while ($row = mysqli_fetch_array($results)) { ?>
        <tr>
            ...
            <td><?php echo $row['email']; ?></td> 
             ...
             <td>
                <a href="faculty.php?edit=<?php echo $row['id']; ?>" class="edit_btn" >Edit</a>
            </td>
